...
DECLARE_CLASS_CODEGEN_INTERFACES(AudioLink, AudioLinkObj, Il2CppObject, Zenject::ITickable*, Zenject::IInitializable*, ::System::IDisposable*) {
    ...
    DECLARE_INSTANCE_FIELD_PRIVATE(UnityW<UnityEngine::AudioSource>, _audioSource);
    DECLARE_INSTANCE_FIELD_PRIVATE(UnityW<UnityEngine::Material>, _audioMaterial);
    DECLARE_INSTANCE_FIELD_PRIVATE(UnityW<UnityEngine::GameObject>, _testPlane);
