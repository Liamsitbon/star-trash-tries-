...
MAKE_HOOK_MATCH(BeatmapObjectManager_HandleNoteControllerNoteWasCut,
  ...
  if (!noteCutCoreEffectsSpawner || !noteCutCoreEffectsSpawner.value()) {
    NELogger::Logger.error("Fake note cut skipped because NoteCutCoreEffectsSpawner is unavailable; note will be despawned safely");
