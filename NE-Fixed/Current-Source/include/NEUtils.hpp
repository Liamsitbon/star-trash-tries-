...
// Port of Unity/MathF Approximately. Slider and time-row matching must share
// the same tolerance so fractional Noodle coordinates link consistently.
inline bool Approximately(float a, float b) {
  constexpr float epsilon = 1.17549435E-38f * 8.0f;
